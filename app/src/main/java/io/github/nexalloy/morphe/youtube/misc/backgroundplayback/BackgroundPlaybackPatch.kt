...
import io.github.nexalloy.morphe.shared.misc.litho.filter.forceBooleanFeatureFlag
...
val BackgroundPlayback = patch(
    ...
    if (!is_21_21_or_greater) {
        forceBooleanFeatureFlag(PIP_INPUT_CONSUMER_FEATURE_FLAG, false)
    }
    ...
    if (is_20_29_or_greater) {
        ...
        forceBooleanFeatureFlag(45698813L, false)
    }
    ...
    if (is_21_04_or_greater) {
        ...
        forceBooleanFeatureFlag(45752335L, false)
    }
}
